 ...
 * IR code generators (Hint: use import static ir.tree.IR.*
...
public class IR {
	...
	public static final IRExp NULL = CONST(0);
	...
	public static IRExp CALL(IRExp target, List<IRExp> args) {
	...
	public static IRStm CMOVE(RelOp compare, IRExp l, IRExp r, IRExp dst, IRExp src) {
		return new CMOVE(compare, l, r, dst, src);
	}
	...
	public static IRExp MINUS(IRExp l, IRExp r) {
	...
	public static IRExp MUL(IRExp l, IRExp r) {
...
//		if (r.isCONST(0)) return r;
	...
	public static IRExp NAME(Label lab) {
		return new NAME(lab);
	}
	...
	public static IRData DATA(Label l, List<IRExp> data) {
		return new IRData(l, data);
	}
}

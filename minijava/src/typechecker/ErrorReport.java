...
public class ErrorReport {
	...
	public void undefinedClass(String name) {
		report(ErrorMessage.undefinedClass(name));
	}

	public void undefinedMethod(String classname, String methodname) {
		report(ErrorMessage.undefinedMethod(classname, methodname));		
	}
	...
	public void invalidLvalue(Expression exp) {
		report(ErrorMessage.invalidLvalue(exp));
	}

...
public class ErrorMessage {
	...
	public static ErrorMessage undefinedClass(String name) {
		return new ErrorMessage("Undefined Object Type: "+name);
	}

	public static ErrorMessage undefinedMethod(String classname, String methodname) {
		return new ErrorMessage("Undefined Method "+methodname+"() in Class "+classname);
	}
	...
	public static ErrorMessage typeError(Expression exp, Type expected,
			Type actual) {
		if (actual == null) {
			return new ErrorMessage(exp+" has type (undefined) expected "+expected);
		}
	...
	public static ErrorMessage invalidLvalue(Expression exp) {
		return new ErrorMessage(exp+" is invalid L-value");
	}

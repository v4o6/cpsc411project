...
public class IRPat {
	...
	public static Pat<IRExp> MUL(Pat<IRExp> x, Pat<IRExp> y, Pat<IRExp> z) {
		return or( MUL( x, MUL(y, z) ), 
				   MUL( MUL(x, y), z) );
	}
	public static Pat<IRExp> MINUS(Pat<IRExp> l, Pat<IRExp> r) {
		return BINOP(Op.MINUS, l, r);
	}
	public static Pat<IRExp> XOR(Pat<IRExp> l, Pat<IRExp> r) {
		return BINOP(Op.XOR, l, r);
	}

/* Generated By:JavaCC: Do not edit this line. JCCFunctionsParser.java */
package parser.jcc;
...
public class JCCFunctionsParser implements JCCFunctionsParserConstants {
  ...
  final public Statement FunctionDeclaration() throws ParseException {
        Type type;
        String name;
        FormalList params;
    ...
    case TYPE:
      ...
      jj_consume_token(RBRACKET);
                          {if (true) return new FunctionDeclaration(type, name, params, statements, value);}
      break;
    case IDENTIFIER:
      s = Assign();
                  {if (true) return s;}
...
/* PrimaryExpression is the expression that has highest precedence.*/
  ...
  final public Expression IdentifierPrime() throws ParseException {
        String name;
        Expression e;
        ExpressionList args;
    name = Identifier();
  ...
  public JCCFunctionsParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x2000200,0x2000000,0x2000200,0x2000,0x40000,0x18000,0x18000,0x20000,0x3080400,0x3000400,0x800000,0x200,0x400,0x800000,0x3080400,};
   }

  /** Constructor with InputStream. */
  public JCCFunctionsParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public JCCFunctionsParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new JCCFunctionsParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public JCCFunctionsParser(java.io.Reader stream) {
  ...
  public JCCFunctionsParser(JCCFunctionsParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(JCCFunctionsParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
